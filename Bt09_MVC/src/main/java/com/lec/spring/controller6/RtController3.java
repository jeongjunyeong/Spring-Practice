...
public class RtController3 {
   ...
   """,
    ...
    public String mapTest1(){
        String url = "http://localhost:8080/server/0"; // 반드시 절대경로이어야 한다.
    ...
    static class Data2 {
        String status;
        Integer code;
        @JsonProperty("response_time") // -> 바꿔주는 역할
        String responseTime;
    }
    ...
    public String mapTest3(){
        String url = "http://localhost:8080/server/1"; // 반드시 절대경로이어야 한다.
    ...
    public String mapTest4(){
        String url = "http://localhost:8080/server/2"; // 반드시 절대경로이어야 한다.
    ...
    public String mapTest5(){
        String url = "http://localhost:8080/server/4"; // 반드시 절대경로이어야 한다.

        List<String> output = new ArrayList<>();

        {   //Json object 를 => map 으로 바꾸어줌
...
//    }
    ...
    // json object 의 배열 -> java object 의 list
    ...
    public String mapTest10(){
       String url = "http://localhost:8080/server/4";
       var result = rt.getForObject(url, ResultDTO.class);
