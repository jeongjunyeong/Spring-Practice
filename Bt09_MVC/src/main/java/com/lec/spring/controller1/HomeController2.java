...
public class HomeController2 {
   ...
   """,
    ...
    public HttpEntity<String> http01(){
        String body = str1;
//        HttpEntity<T> T 는 response 할 body 타입
        HttpEntity<String> entity = new HttpEntity<>(body);
        return entity;
        // 기본적으로 Content type 은 text/html 로 response 된다.
    }
...
//        headers.setContentType(MediaType.TEXT_PLAIN);  // text//plain 으로 response
        ...
        headers.add("my-team", URLEncoder.encode("삼성라이온즈","utf-8")); // 에러
    ...
    public ResponseEntity<String> http03() {
        ...
        ResponseEntity<String> entity = new ResponseEntity<>(body,headers, HttpStatus.OK);; // (bodyㅘ , headsers)
