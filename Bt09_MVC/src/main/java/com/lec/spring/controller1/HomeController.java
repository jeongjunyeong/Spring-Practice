...
//    }
    ...
    public void httpServletRequest(HttpServletRequest request, Model model){  // 매개변수 순서 관계없다!
    ...
    @RequestMapping("/ccc")
    @ResponseBody // 그냥 문자열 자체를 리턴하게 된다.
    public String ccc(){
        return "/ccc";
    }
 ...
 */
    ...
    // get 과 post 두가지 request method 에 대해서 동작 시키려면?
    ...
    // 서로 다른 url 의 요청들에 대해서 handler 로 처리 가능
