...
class AuthorRepositoryTest {
    ...
    void manyToManyTest() {
        ...
        Book book1 = givenBook("고양이책 1");
        Book book2 = givenBook("고양이책 2");

        Book book3 = givenBook("고양이책 2");
        Book book4 = givenBook("멍멍이책1 ");

        Author author1 = givenAuthor("cat");
        Author author2 = givenAuthor("dog");
...
//        author2.addBook(book2, book3, book4);
        ...
        // book, author 를 save --> 중간 테이블에 insert 발생 _> 6번!
